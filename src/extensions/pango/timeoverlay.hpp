...
class GstTimeOverlay : public INvDsElement {
 public:
  ...
  gxf_result_t bin_add(GstElement *pipeline) override {
    ...
    0x704b6eacc0b0 (GDateTime at 0x17edf80)>) { GDateTime propvalue =
    ...
    /* auto p_reference_timestamp_caps = reference_timestamp_caps.try_get();
    if (p_reference_timestamp_caps) {
      GstCaps *propvalue =
    gst_caps_from_string(p_reference_timestamp_caps.value().c_str());
      g_object_set (element_, "reference-timestamp-caps", propvalue, NULL);
  ...
  gxf_result_t registerInterface(nvidia::gxf::Registrar *registrar) override {
    ...
    // (1900-01-01)", <GLib.DateTime object at 0x704b6eacc0b0 (GDateTime at
    // 0x17edf80)>, GXF_PARAMETER_FLAGS_OPTIONAL);
    result &= registrar->parameter(
    ...
    // result &= registrar->parameter(reference_timestamp_caps,
    // "reference-timestamp-caps", "Reference Timestamp Caps", "Caps to use for
    // the reference timestamp time mode", gxf::Registrar::NoDefaultParameter(),
    // GXF_PARAMETER_FLAGS_OPTIONAL);
    result &= registrar->parameter(
        src_pad, "video-out", "video-out",
        "Handle to a nvidia::deepstream::NvDsStaticOutput component. Supported "
        "formats - video(A444_16LE, A444_16BE, AYUV64, RGBA64_LE, ARGB64, "
        "ARGB64_LE, BGRA64_LE, ABGR64_LE, RGBA64_BE, ARGB64_BE, BGRA64_BE, "
        "ABGR64_BE, A422_16LE, A422_16BE, A420_16LE, A420_16BE, A444_12LE, "
        "GBRA_12LE, A444_12BE, GBRA_12BE, Y412_LE, Y412_BE, A422_12LE, "
        "A422_12BE, A420_12LE, A420_12BE, A444_10LE, GBRA_10LE, A444_10BE, "
        "GBRA_10BE, A422_10LE, A422_10BE, A420_10LE, A420_10BE, BGR10A2_LE, "
        "RGB10A2_LE, Y410, A444, GBRA, AYUV, VUYA, RGBA, RBGA, ARGB, BGRA, "
        "ABGR, A422, A420, AV12, Y444_16LE, GBR_16LE, Y444_16BE, GBR_16BE, "
        "v216, P016_LE, P016_BE, Y444_12LE, GBR_12LE, Y444_12BE, GBR_12BE, "
        "I422_12LE, I422_12BE, Y212_LE, Y212_BE, I420_12LE, I420_12BE, "
        ...
        "MT2110T, NV12_10BE_8L128, NV12_10LE40_4L4, Y444, BGRP, GBR, RGBP, "
        "NV24, v308, IYU2, RGBx, xRGB, BGRx, xBGR, RGB, BGR, Y42B, NV16, NV61, "
        "YUY2, YVYU, UYVY, VYUY, I420, YV12, NV12, NV21, NV12_16L32S, "
        "NV12_32L32, NV12_4L4, NV12_64Z32, NV12_8L128, Y41B, IYU1, YUV9, YVU9, "
        "BGR16, RGB16, BGR15, RGB15, RGB8P, GRAY16_LE, GRAY16_BE, GRAY10_LE32, "
        "GRAY8)",
  ...
  // nvidia::gxf::Parameter<std::string> reference_timestamp_caps;
...
#define GXF_EXT_FACTORY_ADD_GstTimeOverlay()                                  \
  do {                                                                        \
    GXF_EXT_FACTORY_ADD_VERBOSE(                                              \
        0x91bb95174f053730UL, 0xb93f814d7db01855UL,                           \
